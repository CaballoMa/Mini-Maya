...
void Camera::RecomputePSAttributes()
{
    glm::mat4 I = glm::mat4(1);

    glm::mat4 plMat = glm::rotate(I, glm::radians(theta), glm::vec3(0, 1, 0))
                     * glm::rotate(I, glm::radians(phi), glm::vec3(1, 0, 0))
                     * glm::translate(I, glm::vec3(0, 0, zoom));

    eye = glm::vec3(plMat * glm::vec4(0, 0, 0, 1));
    look = glm::vec3(plMat * glm::vec4(0, 0, 1, 0));
    up = glm::vec3(plMat * glm::vec4(0, 1, 0, 0));
    right = glm::vec3(plMat * glm::vec4(1, 0, 0, 0));
}
